...
INSERT INTO posts (id, user_id, title, created_at, updated_at, loc, cat, message, upvotes, downvotes, comment_num) VALUES (1, 1, 'My cat', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,'New Jersey', 'image', 'this is a pic of my cat[href to cat]', 9, 2, 3);
